...
export default function UsagePanel() {
  ...
  return <div>
    ...
    <div className="mt-6 rounded-xl border border-[#f1dfd7] bg-[#fffaf7] p-4 sm:p-5"><div className="flex flex-wrap items-end justify-between gap-3"><div><p className="text-xs font-semibold text-[#8d98a9]">Beta guardrail · successful AI workflow runs</p><p className="mt-2 text-2xl font-semibold tracking-[-0.04em] text-[#192235]">{used} <span className="text-sm font-normal text-[#8d98a9]">of {BETA_AI_RUN_LIMIT}</span></p></div><p className="text-xs text-[#8d98a9]">Session-only meter</p></div><div className="mt-4 h-2 overflow-hidden rounded-full bg-[#f2e4df]"><div className="h-full rounded-full bg-[#d17b54] transition-[width]" style={{ width: `${percent}%` }} /></div><p className="mt-3 text-xs leading-5 text-[#68748a]">This is not billing, a payment, or a claim about account-wide usage. Server-side enforcement and subscription billing remain separate work.</p></div>
    <div className="mt-4 grid gap-3 sm:grid-cols-3"><div className="rounded-xl border border-[#e3e7ee] bg-white p-4"><p className="text-[10px] font-bold uppercase tracking-[0.12em] text-[#8d98a9]">Current plan</p><p className="mt-2 text-sm font-semibold text-[#192235]">Beta workspace</p><p className="mt-1 text-xs text-[#8d98a9]">No charge configured</p></div><div className="rounded-xl border border-[#e3e7ee] bg-white p-4"><p className="text-[10px] font-bold uppercase tracking-[0.12em] text-[#8d98a9]">Provider</p><p className="mt-2 text-sm font-semibold text-[#192235]">OpenAI Responses</p><p className="mt-1 text-xs text-[#8d98a9]">Configured server-side</p></div><div className="rounded-xl border border-[#e3e7ee] bg-white p-4"><p className="text-[10px] font-bold uppercase tracking-[0.12em] text-[#8d98a9]">Next control</p><p className="mt-2 text-sm font-semibold text-[#192235]">Server enforcement</p><p className="mt-1 text-xs text-[#8d98a9]">Planned for operational hardening</p></div></div>
  </div>;
}
