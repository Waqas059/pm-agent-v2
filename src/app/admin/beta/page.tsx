...
export default function BetaAdminPage() {
  ...
  return <main className="beta-admin-page">
    ...
    {tab === "participants" && <section className="beta-admin-section">
      <p className="beta-admin-user-flow-note">Participants now start from the public Bootstrap PM page. This view monitors registration, activation, usage, and follow-up signals.</p>
