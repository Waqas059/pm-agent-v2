...
export type Database = {
  public: {
    Tables: {
      ...
      beta_participants: {
        Row: { id: string; full_name: string; preferred_name: string | null; email: string; status: "invited" | "registered" | "pending_access" | "active" | "paused" | "declined"; request_allowance: number; country_code: string | null; country_name: string | null; country_first_detected_at: string | null; country_last_detected_at: string | null; auth_user_id: string | null; created_at: string; updated_at: string };
